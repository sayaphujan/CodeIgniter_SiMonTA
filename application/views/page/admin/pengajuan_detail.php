<div class="content-page-inner">
					...
					<div class='the-box full'>
						<div class="table-responsive" style="margin:5px;padding:5px" id="stack-personal">
							...
							<a href="<?php echo site_url('admin/'.$red);?>" class="btn btn-warning btn-square">Kembali</a> */ ?>
							<a href="javascript:history.back()" class="btn btn-warning btn-square">Kembali</a>
							</div>
						</div>
					</div>