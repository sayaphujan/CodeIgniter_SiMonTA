							...
							<table id="tbl-personal" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
										  ...
										  ?>
										   <tr>
											   <td><?php echo $no++?></td>
											   <td><?php echo $kon->jur_nama;?></td>
											   <td><?php echo $kon->kon_nama;?></td>
											   <td>
													<a href='<?php echo site_url('admin/konsentrasi/edit/'.$kon->kon_id); ?>'>
														<button class="btn btn-xs btn-flat btn-success btnbrg-edit">
															<i class="fa fa-edit"></i>
														</button>
													</a>
													<a href='<?php echo site_url('admin/konsentrasi/del/'.$kon->kon_id); ?>' onClick="return confirm('Anda yakin akan menghapus data ini ?')" >
