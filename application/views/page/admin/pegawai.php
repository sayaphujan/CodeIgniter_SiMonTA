<div class="content-page-inner">
					<div class="container-fluid">
						...
						<div class="the-box full">
                            ...
                            <p><a href="<?php echo site_url('admin/dosen/add');?>"><button class="btn btn-primary btn-square">Add Data</button></a></p>
                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<td><?php echo $pgw->pgw_username;?></td>
													<td><img src='<?php echo site_url('assets/mahasiswa/'.$pgw->pgw_foto); ?>' width='20%'></td>
													<td>
														<a href='<?php echo site_url('admin/dosen/edit/'.$pgw->pgw_id); ?>'>
														<button class="btn btn-xs btn-flat btn-success btnbrg-edit">
															<i class="fa fa-edit"></i>
														</button>
														</a>
														<a href='<?php echo site_url('admin/dosen/del/'.$pgw->pgw_id); ?>' onClick="return confirm('Anda yakin akan menghapus data ini ?')" >
