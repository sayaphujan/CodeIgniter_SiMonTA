<div class="content-page-inner">
					<div class="container-fluid">
						...
						<div class="the-box full">
                            ...
                            <p><strong>LIST DOSEN PEMBIMBING AKADEMIK</strong></p>
                            <p><a href="<?php echo site_url('admin/pa/pa_add');?>"><button class="btn btn-primary btn-square">Add Data</button></a></p>
							<table id="tbl-personal" class="table table-bordered table-hover">
										...
										<tr>
										   ...
										   <td><?php echo $nama?></td>
										   <td><?php echo $nim?></td>
										   <td><?php echo $mnama?></td>
										   <td><?php echo $kon?></td>
										   <td>
											<a href='<?php echo site_url('admin/pa/pa_edit/'.$p->akad_id); ?>'>
												<button class="btn btn-xs btn-flat btn-success btnbrg-edit">
													<i class="fa fa-edit"></i>
												</button>
											</a>
											<!--
											<a href='<?php //echo site_url('admin/pa/del/'.$p->akad_id); ?>' onClick="return confirm('Anda yakin akan menghapus data ini ?')" >
