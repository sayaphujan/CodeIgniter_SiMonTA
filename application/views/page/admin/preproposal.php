<div class="content-page-inner">
					<div class="container-fluid">
						...
						<div class="the-box full">
                            ...
                            <p><strong>DATA MAHASISWA BIMBINGAN</strong></p>
                            <!--<p><a href="<?php echo site_url('admin/proposal/pre');?>"><button class="btn btn-primary btn-square">Add Data</button></a></p>-->
...
$(document).ready(function() {
    ...
    var oTable = $('#tbl-personal').dataTable( {
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": '<?php echo site_url('admin/proposal/get_pre');?>',
                "bJQueryUI": false,
                "iDisplayStart ":20,
                "oLanguage": {
            "sProcessing": ""
