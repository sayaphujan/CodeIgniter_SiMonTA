						...
						<div class="alert alert-success alert-bold-border fade in alert-dismissable">
						  <h3>FORM DATA MAHASISWA</h3>
							...
							<div class="the-box full">
							 <form role="form" class="form-horizontal" enctype="multipart/form-data" action="<?=site_url('admin/mahasiswa/submit/'.$jur->jur_id.'/'.$kon->kon_id.'/'.$tahun);?>" method="POST" >
								<div class="form-group">
									<label class="col-sm-2 control-label">Nim</label>
									<div class="col-sm-8">
										<?php
											}
										echo substr($this->uri->segment(6),2,2).'.'.$jur->jur_kode.'.'.$last_nim;
										?>
										<input name="nim" class="form-control" id="nim" type="hidden" value="<?php echo substr($this->uri->segment(6),2,2).'.'.$jur->jur_kode.'.'.$last_nim; ?>" />
									</div>
								</div>
