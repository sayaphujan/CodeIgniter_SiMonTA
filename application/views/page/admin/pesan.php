					...
					<div class="container-fluid">
						...
						<div class="the-box full">
							...
							<table id="tbl-personal" class="table table-bordered table-hover">
										...
										<tr>
                                           <td><?php echo $no++?></td>
										   <td><?php echo "<b>".$p->mhs_nama."</b>"; ?>&nbsp; Mengajukan <?php echo "<b>".$p->kat_lap."</b>"; ?></td>
										   ...
										   <a href="<?php echo site_url('admin/dashboard/detail/'.$p->pesan_id.'/'.$p->mhs_id.'/'.$p->kat_lap_id);?>" />
											...
											<td width="50px">
											   ...
											   if($p->pesan_status==0){
											   ?>
											   <a href='<?php echo site_url('admin/dashboard/open/'.$p->pesan_id); ?>' onClick="return confirm('Tandai Pesan Sudah Terbaca?')" >
										   ...
										   <td>
												<a href='<?php echo site_url('admin/dashboard/del/'.$p->pesan_id); ?>' onClick="return confirm('Anda yakin akan menghapus data ini ?')" >
