<div class="content-page-inner">
					<div class="container-fluid">
						...
						<div class="the-box full">
                            ...
                            <p><strong>LIST TEMA</strong></p>
                            <p><a href="<?php echo site_url('admin/tema/data');?>"><button class="btn btn-primary btn-square">Add Data</button></a></p>
							<table id="tbl-personal" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
										   ...
										   <tr>
												...
												<td><?php echo $tema;?></td>
												<td>
													<a href='<?php echo site_url('admin/tema/data/'.$id); ?>'>
														<button class="btn btn-xs btn-flat btn-success btnbrg-edit">
															<i class="fa fa-edit"></i>
														</button>
													</a>
													<a href='<?php echo site_url('admin/tema/del/'.$id); ?>' onClick="return confirm('Anda yakin akan menghapus data ini ?')" >
