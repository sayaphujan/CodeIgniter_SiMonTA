...
class Laporan extends CI_Controller
{
	...
	function index(){
		...
		$this->template->load2('template-admin','page/admin/laporan');
	}
	
	function bimbingan(){
		$this->template->load2('template-admin','page/admin/bimbingan');
	}
	...
	function get_peng(){
		...
		->add_column('aksi',
        	'<a href="'.site_url('admin/pengajuan/edit/$1').'">
	...
	function get_prodi(){
		...
		->join('mahasiswa','mahasiswa.mhs_id=pengajuan.mhs_id')
		->join('tema','tema.tema_id=pengajuan.tema_id')
		->where('peng_status','DIETUJUI DOSEN PA')
		->add_column('aksi',
        	'<a href="'.site_url('admin/pengajuan/pa_edit/$1').'">
				<button class="btn btn-xs btn-flat btn-success btnbrg-edit">
					<i class="fa fa-edit"></i>
